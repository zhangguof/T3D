...
void Render::draw_triangle(Vec3f vertexs[],Color color)
{
	int points[] = {
		int(round(vertexs[0].x)),int(round(vertexs[0].y)),
		int(round(vertexs[1].x)),int(round(vertexs[1].y)),
		int(round(vertexs[2].x)),int(round(vertexs[2].y)),
	};
